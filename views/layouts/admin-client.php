        ...
        <nav class="navigation">
            <ul class="navi-acc" id="nav2">
                <li>
                    ...
                    <ul>
                        <li><a href="profile-client">Профиль</a></li>
                        <li><a href="location-client">Место</a></li>
                        <li><a href="password-client">Cменить пароль</a></li>
                    </ul>
                </li>
                <li>
                    <a href="certificates-client" class="pages">Сертификаты</a>
                </li>
                <li>
                    <a href="calendar-client" class="dashboard">Календарь</a>
                </li>
                <li>
                    <a href="#messages" class="mailbox">Сообщения<span class="label label-custom1">2</span></a>
                    <ul>
                        <li><a href="inbox-client">Входящие</a></li>
                        <li><a href="compose-client">Новое сообщение</a></li>
                        <li><a href="message-client">Подробно</a></li>
                    </ul>
                </li>
            </ul><!-- /.navi-acc -->
...
<div class="right-sec">
    ...
    <header>
        ...
        <a href="request-client" class="btn btn-success btn-main-action">Отправить заявку</a>
        <!-- Create Request end -->

        <!-- User Section Start -->
        <div class="user">
            <figure>
                <a href="profile-client"><img src="../assets-admin/images/client.jpg" alt="Клиент" /></a>
            </figure>
            <div class="welcome">
                <p>Здравствуйте</p>
                <h5><a href="profile-client">Семен Горбунков</a></h5>
            </div><!-- /.welcome -->
        </div><!-- /.user -->
        <!-- User Section End -->
        ...
        <nav class="topnav">
            <ul id="nav1">
                ...
                <li class="inbox">
                    <a href="inbox-client"><i class="glyphicon glyphicon-envelope"></i>Сообщения<span> (2)</span></a>
                </li>
            </ul><!-- /#nav1 -->
        </nav><!-- /.topnav -->
